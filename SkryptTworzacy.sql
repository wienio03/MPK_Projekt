...
CREATE TABLE Tramwaje(
    ...
    zajezdnia VARCHAR(50) REFERENCES ZajezdnieTramwajowe(nazwa),
...
CREATE TABLE Autobusy(
    ...
    zajezdnia VARCHAR(50) REFERENCES ZajezdnieAutobusowe(nazwa),
    stan stanPojazdu NOT NULL
...
CREATE TABLE KursyTramwajowe(
    ...
    pojazd VARCHAR(10) REFERENCES Tramwaje,
    linia INT REFERENCES LinieTramwajowe,
    kierowca VARCHAR REFERENCES KierowcyTramwajow,
...
CREATE TABLE KursyAutobusowe(
    idKursu INT PRIMARY KEY,
    pojazd VARCHAR(10) REFERENCES Autobusy,
    linia INT REFERENCES LinieAutobusowe,
    kierowca VARCHAR REFERENCES KierowcyAutobusow,
    godzinaOdjazdu TIME NOT NULL
);
